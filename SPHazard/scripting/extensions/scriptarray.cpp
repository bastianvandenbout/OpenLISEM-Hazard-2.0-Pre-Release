...
//conversion to simple list types for internal use

bool CScriptArray::IsNumberType()
{
    int typeId = GetElementTypeId();
    if(typeId == asTYPEID_BOOL || typeId == asTYPEID_INT8 || typeId == asTYPEID_INT16 || typeId == asTYPEID_INT32
            ||typeId == asTYPEID_INT64 || typeId == asTYPEID_UINT8 || typeId == asTYPEID_UINT16
...
QList<double> * CScriptArray::ToQListDouble()
{
    if(IsNumberType())
    {
        QList<double> * ret = new QList<double>();
        int in_typeid = GetElementTypeId();
        if(in_typeid == asTYPEID_BOOL)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((bool*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_INT8)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((int8_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_INT16)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((int16_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_INT32)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((int32_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        //The type id for int.
        ...
        if(in_typeid == asTYPEID_INT64)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((int64_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_UINT8)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((uint8_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_UINT16)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((uint16_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_UINT32)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((uint32_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_UINT64)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((uint64_t*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_FLOAT)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((float*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
        ...
        if(in_typeid == asTYPEID_DOUBLE)
        {
            for(int i = 0; i < this->GetSize(); i++)
            {
                double val = (double)(*((double*)GetArrayItemPointer(i)));
                ret->append(val);
            }
        }
