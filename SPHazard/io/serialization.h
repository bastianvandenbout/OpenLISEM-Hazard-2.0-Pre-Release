...
namespace SPHSerialize
{
    ...
    static inline void FromString(QJsonObject * obj,  QString name, SPHStringable &x)
    {
        obj->insert(name,x.toString());
    }
    static inline bool ToString(QJsonObject * obj,  QString name, SPHStringable &x)
    {
    ...
    template <typename A>
    static inline void To(QJsonObject * obj,QString name,SPHStringable &x)
    {
        ToString(obj,name,x);
    }
