...
public:
    ...
    double         cell_sizeX           () const;

    double         cell_sizeY           () const;
...
inline Raster<T>::Raster(
    ...
    : Array<T, 2>(nr_rows, nr_cols),
      ...
      _cell_sizeX(cell_size),
      _cell_sizeY(cell_size)
...
inline Raster<T>::Raster(
    ...
    : Array<T, 2>(nr_rows, nr_cols),
      _north(north),
      _west(west),
      _cell_size(cell_sizeX),
      _cell_sizeX(cell_sizeX),
      _cell_sizeY(cell_sizeY)
...
template<
    typename T>
inline double Raster<T>::cell_sizeX() const
{
    return _cell_sizeX;
}
...
template<
    typename T>
inline double Raster<T>::cell_sizeY() const
{
    return _cell_sizeY;
}
