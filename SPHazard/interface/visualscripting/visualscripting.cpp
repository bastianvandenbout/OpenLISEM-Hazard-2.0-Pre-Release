...
VisualScriptingTool::VisualScriptingTool(ScriptManager * sm,QWidget * parent): QWidget(parent)
{
    ...
    connect(m_Scene,&FlowScene::nodePlaced,this,&VisualScriptingTool::OnNodePlaced);
    connect(m_Scene,&FlowScene::nodeDeleted,this,&VisualScriptingTool::OnNodeDeleted);
    connect(m_Scene,&FlowScene::connectionCreated,this,&VisualScriptingTool::connectionCreated);
    connect(m_Scene,&FlowScene::connectionDeleted,this,&VisualScriptingTool::connectionDeleted);
...
#define SPH_VISUALSCRIPT_DEBUG

#ifdef SPH_VISUALSCRIPT_DEBUG
#define SPHVSDB(x) x
#else
#define SPHVSDB(x) ;
#endif
