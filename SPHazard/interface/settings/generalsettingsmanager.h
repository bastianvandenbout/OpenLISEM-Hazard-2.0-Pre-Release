...
#define SPH_FILE_GENERALSETTINGS "settings.ini"
...
public:
    ...
    inline void LoadFromFile()
    {
        ...
        if (!fin.open(QFile::ReadOnly | QFile::Text)) {
            ...
            SPH_DEBUG("No settings file exists");
            return;
        }
        ...
        while (!fin.atEnd())
        {
            QString S = fin.readLine().trimmed();
                ...
                if (S.contains("=") && !S.startsWith("["))
                {
                    ...
                    {
                        SPH_ERROR("Could not read parameter in settings : " + S);
                    }
    ...
    inline void UpdateFile()
    {
        ...
        {
            SPH_ERROR("Could not write settings file");
            return;
        }
...
extern GeneralSettingsManager * CGSManager;
