...
public:
    ...
    inline VectorConstructInfo GetMapInfo()
    {
        ...
        {
            info.shapetype = SPH_SHAPE_POINT;
        }else if(buttonc2->isChecked())
        {
            info.shapetype = SPH_SHAPE_LINE;
        }else if(buttonc3->isChecked())
        {
            info.shapetype = SPH_SHAPE_POLYGON;
        }else if(buttonc4->isChecked())
        {
            info.shapetype = SPH_SHAPE_MULTIPOINT;
        }else if(buttonc5->isChecked())
        {
            info.shapetype = SPH_SHAPE_MULTILINE;
        }else if(buttonc6->isChecked())
        {
            info.shapetype = SPH_SHAPE_MULTIPOLYGON;
        }
