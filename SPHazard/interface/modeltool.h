...
public:
    ...
    inline ModelTool( SPHModel * m, MODELTOINTERFACE *minterface, MapViewTool  * mpview, ParameterManager * pm,QWidget *parent = 0): QWidget( parent)
    {
        ...
        QIcon icon_del;
        icon_del.addFile((m_Dir + SPH_FOLDER_ASSETS + "deletereport4.png"), QSize(), QIcon::Normal, QIcon::Off);
