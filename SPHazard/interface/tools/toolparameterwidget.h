...
public:
    ...
    inline GeoProjectionSelectWidget(QString DefaultValue = "")
    {
        ...
        QIcon iconCRS;
        iconCRS.addFile((m_Dir + SPH_FOLDER_ASSETS + "globe.png"), QSize(), QIcon::Normal, QIcon::Off);
...
public:
    ...
    inline MapSelectWidget(QString DefaultValue= "")
    {
        ...
        connect(m_LoadFromFile,&QToolButton::clicked,this,&MapSelectWidget::LoadViewClicked);
        connect(m_LoadFromFile,&QToolButton::clicked,this,&MapSelectWidget::LoadConstantClicked);
    }
    inline void SetValue(QString x)
    {
...
public:
    ...
    inline SPHVector2 GetPoint()
    {
        return SPHVector2(m_MinX->value(),m_MinY->value());
    }
    inline QString GetValue()
    {
...
static inline ParameterSelectionWidget * GetSelectionWidgetFromType(SPHScriptEngine * sm, int as_type,QString DefaultValue = "")
{
