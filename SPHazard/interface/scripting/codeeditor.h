...
public:
    ...
    inline void SetFile(QString file)
    {
        ...
        int ok = false;
        QStringList filetext = IOManager::ReadFileAsText(file,false,&ok);

        QString plaintext;
        for(int i = 0; i < filetext.length(); i++)
        {
            plaintext.append(filetext.at(i));
        }
    ...
    inline void LoadFile(QString startdir)
    {
        ...
        {
           openDir = QCoreApplication::applicationDirPath();
        ...
        QString path = QFileDialog::getOpenFileName(this,
                                            ...
                                            openDir,
                                            QString("*") + SPH_FILE_EXT_SCRIPT + QString(";*.*"));
    ...
    inline void SaveFile(bool askname = false)
    {
        ...
        if(askname)
        {
            ...
            fileName = QFileDialog::getSaveFileName(this,
                                                            ...
                                                            QString("sph"),
                                                            QString("SPH Script Files (*") + SPH_FILE_EXT_SCRIPT + QString(");;All Files (*)"),
                                                            &selectedFilter);
        ...
        {
            SPH_DEBUG("Could not write file to disk: " + fileName);
            return;
        }
