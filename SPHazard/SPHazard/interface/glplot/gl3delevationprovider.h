...
public:
    ...
    {
        m->CopyTextureToMap(t,m_ElevationMaps.at(l));
    ...
    inline void GetClosestTerrain(SPHVector3 Position)
    {

    }

    inline SPHVector3 RayCast(SPHVector3 From, SPHVector3 dir, bool globe = false, float conv_m = 1.0)
    {



        return SPHVector3(0.0,0.0,0.0);
    }
