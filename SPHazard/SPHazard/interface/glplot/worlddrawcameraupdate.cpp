...
bool WorldWindow::UpdateCamera()
{
    ...
    {
        m_Camera2DController->OnMouseMove(SPHVector2(m_MouseState.Pos_x,m_MouseState.Pos_y),SPHVector2(m_MouseState.Move_X,m_MouseState.Move_Y));
        m_Camera3DController->OnMouseMove(SPHVector2(m_MouseState.Pos_x,m_MouseState.Pos_y),SPHVector2(m_MouseState.Move_X,m_MouseState.Move_Y));
    }
    if(std::abs(m_MouseState.MoveScroll_X) > 0 || std::abs(m_MouseState.MoveScroll_Y) > 0)
    {
        if(!shift)
        {
            m_Camera2DController->OnMouseScroll(SPHVector2(m_MouseState.Scroll_x,m_MouseState.Scroll_y),SPHVector2(m_MouseState.MoveScroll_X,m_MouseState.MoveScroll_Y));
            m_Camera3DController->OnMouseScroll(SPHVector2(m_MouseState.Scroll_x,m_MouseState.Scroll_y),SPHVector2(m_MouseState.MoveScroll_X,m_MouseState.MoveScroll_Y));
        }
    }
    ...
    if(dragx != 0.0f || dragy != 0.0f)
    {
        if(!shift)
        {
           m_Camera2DController->OnMouseDrag(SPHVector2(m_MouseState.Scroll_x,m_MouseState.Scroll_y),SPHVector2(dragx,dragy));
            m_Camera3DController->OnMouseDrag(SPHVector2(m_MouseState.Scroll_x,m_MouseState.Scroll_y),SPHVector2(dragx,dragy));
        }
    }
