...
public:
    ...
    inline void Save(QJsonObject * obj)
    {
        ...
        SPHSerialize::FromQListString(obj,"ZoomLevels",l);
        SPHSerialize::FromString(obj,"URL",m_Url);
        SPHSerialize::FromString(obj,"Name",m_Name);
        SPHSerialize::FromInt(obj,"BackupLevel",m_BackupLevel);
        SPHSerialize::FromInt(obj,"CacheSize",m_cache_size);
        SPHSerialize::FromFloat(obj,"MaxVal",m_max);
        SPHSerialize::FromFloat(obj,"MinVal",m_min);
        SPHSerialize::FromBool(obj,"IsTiff",m_IsTiff);
        QString proj = m_Projection.GetWKT();
        SPHSerialize::FromString(obj,"CRS",proj);
        QString bb = m_Box.toString();
        SPHSerialize::FromString(obj,"BoundingBox",bb);
    }

    inline void Load(QJsonObject * obj)
    {
        QList<QString> l;
        SPHSerialize::ToQListString(obj,"ZoomLevels",l);
        AddZoomLevels(l);
        SPHSerialize::ToString(obj,"URL",m_Url);
        SPHSerialize::ToString(obj,"Name",m_Name);
        SPHSerialize::ToInt(obj,"BackupLevel",m_BackupLevel);
        SPHSerialize::ToInt(obj,"CacheSize",m_cache_size);
        SPHSerialize::ToFloat(obj,"MaxVal",m_max);
        SPHSerialize::ToFloat(obj,"MinVal",m_min);
        SPHSerialize::ToBool(obj,"IsTiff",m_IsTiff);
        QString proj;
        SPHSerialize::ToString(obj,"CRS",proj);
        m_Projection.FromString(proj);
        QString bb;
        SPHSerialize::ToString(obj,"BoundingBox",bb);
        m_Box.fromString(bb);
    }
};
...
class UIWebTileLayer : public UIGeoLayer
{
...
public:
        ...
        inline void Initialize(TileServerInfo info)
        {
            ...
            if(info.m_IsTiff)
            {
                ...
                m_CouldBeDEM = true;
                this->SetStyle(GetStyleDefault(SPH_STYLE_DEFAULT_RASTERUI),true);
            }
        }
        ...
        inline int GetRequiredTiles(GeoWindowState state,WorldGLTransformManager * tm)
        {
            ...
            std::cout <<" downloaded " << n_download << std::endl;
        ...
        inline void UpdateMap(OpenGLCLManager * m, GeoWindowState state, WorldGLTransformManager * tm, int z, bool raw_values = false)
        {
            ...
            {
                TileInfo ti = m_RequiredTiles.at(i);
                if(ti.is_done && !ti.is_gl_created && ti.is_in && n_glcreate < 10)
                {
