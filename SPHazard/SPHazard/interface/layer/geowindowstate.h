...
typedef struct GeoWindowState
{
    ...
    SPHVector3 SunDir = SPHVector3(0.0,0.4,1.0);
    float m_time = 0.0;
...
inline static GeoWindowState ExternalDrawGeoWindowState(int scr_w, int scr_h, BoundingBox b, bool ui, bool legends, bool no_async = true)
{
    GeoWindowState s;
