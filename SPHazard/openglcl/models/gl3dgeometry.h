...
static const Vertex test_vertexes[] = {
  Vertex( SPHVector3( 0.0f,  1.0f, 0.0f), SPHVector3(1.0f, 0.0f, 0.0f) ),
  Vertex( SPHVector3( 0.0f, 0.0f, 1.0f), SPHVector3(0.0f, 1.0f, 0.0f) ),
  Vertex( SPHVector3( 0.0f, 1.0f, 1.0f), SPHVector3(0.0f, 0.0f, 1.0f) )
};
...
{
    Vertex( SPHVector3(-1.0f, -1.0f, -1.0f)),
    Vertex( SPHVector3(-1.0f,  1.0f, -1.0f)),
    Vertex( SPHVector3( 1.0f, -1.0f, -1.0f)),
    Vertex( SPHVector3( 1.0f,  1.0f, -1.0f)),
    Vertex( SPHVector3( 1.0f, -1.0f, -1.0f)),
...
public:
    ...
    inline void CreateFromRegularUnitGrid(int x)
    {
        ...
        for (int c = 0; c < x; c= c + 1){
            ...
            m_VertexData[n*6 + 0] = Vertex(SPHVector3((double)c2,-10.0f,(double)r2));
            m_VertexData[n*6 + 1] = Vertex(SPHVector3((double)c2m,-10.0f,(double)r2));
            m_VertexData[n*6 + 2] = Vertex(SPHVector3((double)c2,-10.0f,(double)r2m));

            m_VertexData[n*6 + 3] = Vertex(SPHVector3((double)c2m,-10.0f,r2m));
            m_VertexData[n*6 + 4] = Vertex(SPHVector3((double)c2,-10.0f,(double)r2m));
            m_VertexData[n*6 + 5] = Vertex(SPHVector3((double)c2m,-10.0f,(double)r2));
