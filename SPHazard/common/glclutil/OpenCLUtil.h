...
extern QString NVIDIA_PLATFORM;
extern QString AMD_PLATFORM;
extern QString MESA_PLATFORM;
extern QString INTEL_PLATFORM;
extern QString APPLE_PLATFORM;
extern QString PREFERRED_PLATFORM;
extern int PREFERRED_DEVICE;

void SetPlatformPreference(const QString&, int id);
void ListPlatforms();
...
inline const char* OCL_GetErrorString(cl_int error)
{
    switch (error)
    {
    case CL_SUCCESS:
